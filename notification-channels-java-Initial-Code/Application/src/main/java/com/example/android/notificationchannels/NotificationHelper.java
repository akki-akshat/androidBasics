...
class NotificationHelper extends ContextWrapper {
    ...
    public static final String MESSAGE_CHANNEL = "Direct Message";
    ...
    public NotificationHelper(Context context) {
        ...
        NotificationChannel messageChannel =
                new NotificationChannel(MESSAGE_CHANNEL,
    ...
    public Notification.Builder getNotificationDM(String title, String body) {
        return new Notification.Builder(getApplicationContext(),MESSAGE_CHANNEL)
                .setContentTitle(title)
                .setContentText(body)
                .setSmallIcon(getSmallIcon())
                .setAutoCancel(true)
